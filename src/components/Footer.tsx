...
export default function Footer() {
  ...
  <a href="https://www.linkedin.com/company/pg-unique-digital-solutions/?viewAsMember=true" aria-label="LinkedIn" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-brand-blue/50 transition-colors">
    <Linkedin size={14} />
  </a>
